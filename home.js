...
// CODE HERE
const canWeDeliverTwo = deliveryAreaZipCodes.includes(85205)
...
//CODE HERE
// const dealChange = typeof deals === 'string' ? deals.replace(/[15% Off]/g) :'10% Off' 
deals[0].title = deals[0].title.replace('15%', '10%')
console.log(deals)

// const dealChange = deals.toString().replace(/[15% Off]/g, '10% Off')
